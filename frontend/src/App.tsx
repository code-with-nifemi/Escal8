...
function App() {
  const [view, setView] = useState<'home' | 'clone' | 'chat' | 'voice-chat'>('home')
    ...
    <div className="min-h-screen bg-slate-50 p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-8 mb-6">
          ...
          <p className="text-gray-600 mb-6">
            Real-time AI voice conversations with intelligent agents
          </p>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-8">
          ...
          {agents.length === 0 ? (
            <p className="text-gray-500 text-center py-8">
              No agents yet. Clone your first agent to get started!
            </p>
          ) : (
            <div className="space-y-4">
              {agents.map((agent) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      disabled={loading}
                      className="bg-gray-900 hover:bg-gray-800 text-white font-semibold py-2 px-4 rounded-lg transition-colors disabled:bg-gray-400 flex items-center gap-2"
                    >
                      <span>🎤</span>
